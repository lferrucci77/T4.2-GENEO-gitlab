...
# The numerical core configuration now lives in geneos_siemens_core.py.
...
GENEO_DEFAULT_MODE = "kafka"
KAFKA_DEFAULT_BOOTSTRAP_SERVERS = "kafka-service.aiaas.svc.cluster.local:9092"
KAFKA_DEFAULT_TRAINING_TOPIC = "kafka.SAG-S1.original"
KAFKA_DEFAULT_EXPLANATION_TOPIC = "kafka.geneos.explanation"
...
from geneos_siemens_core import (
